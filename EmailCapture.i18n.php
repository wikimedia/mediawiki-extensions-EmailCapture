 ...
 */
$messages['azb'] = array(
	'emailcapture' => 'ایمیل دوغرولاماسی',
	'emailcapture-desc' => 'ایمیل آدرسلرینی آل، و ایستیفاده‌چیلره ایجازه وئر ایمیل ایله دوغرولاسینلار',
	'emailcapture-failure' => "سیزین ایمیلینیز '''دوغرولانماییب‌دیر'''.",
	'emailcapture-invalid-code' => 'یانلیش دوغرولاما کودو.',
	'emailcapture-already-confirmed' => 'سیزین ایمیل آدرسینیز، قاباقجادان دوغرولانیب‌دیر.',
	'emailcapture-response-subject' => '{{SITENAME}} ایمیل آدرس دوغرولاماسی',
	'emailcapture-response-body' => 'سلام!

{{SITENAME}}-ی یاخشی‌لاشدیرماق اوچون یاردیم ائتمگه ماراق گؤستردیگینیز اوچون تشکور.

لوطفاً بیر آز واخت قویوب و بو باغلانتی‌نی تیک‌لاماق‌لا، ایمیلینیزی دوغرولایین.
$1

سیز، هم ده بورا گئدیب:
$2

و بو دوغرولاما کودو وئره بیلرسینیز:
$3

بیز آزدان سونرا {{SITENAME}}-ین یاخشی‌لاشدیرماغینا یاردیم ائتمگین نئجه اولودوغونا اؤیرتمگه، سیزین‌له اولاجاییق.

سیز بو ایستگی وئرمه‌میسینیزسه، لوطفاً بو ایمیلی یوخ سایین و بیز ده داها بیر شی سیزه گؤندرمه‌یه‌جگیک.',
	'emailcapture-success' => 'سیزدن تشکور!

سیزین ایمیل آدرسینیز، باشاری‌لا دوغرولاندی.',
	'emailcapture-instructions' => 'ایمیل آدرسینیزی دوغرولاماق اوچون، سیزه ایمیل اولونان کودو یازین و «{{int:emailcapture-submit}}»-ی تیک‌لایین.',
	'emailcapture-verify' => 'دوغرولاما کودو:',
	'emailcapture-submit' => 'ایمیل آدرسینی دوغرولا',
);
 ...
 */
$messages['fa'] = array(
	'emailcapture' => 'تأیید رایانامه',
	'emailcapture-desc' => 'گرفتن نشانی‌های رایانامه‌ای و اجازه‌دادن به کاربران برای تأیید آن‌ها از طریق رایانامه',
	'emailcapture-failure' => "رایانامه شما تأیید '''نشده''' است.",
	'emailcapture-invalid-code' => 'كد تصدیق نامعتبر.',
	'emailcapture-already-confirmed' => 'نشانی رایانامه شما قبلاً تأیید شده‌است.',
	'emailcapture-response-subject' => 'تأیید نشانی رایانامه {{SITENAME}}',
	'emailcapture-response-body' => 'سلام!

از شما برای ابراز علاقه در کمک به بهبود {{SITENAME}} تشکر می‌کنم.

لطفاً لحظه‌ای را برای تأیید رایانامهٔ خود با کلیک بر روی پیوند مقابل، وقت بگذارید:
$1
...
اگر شما این درخواست را نکرده‌اید، لطفاً این رایانامه را نادیده بگیرید و ما چیز دیگری برای شما ارسال نخواهیم کرد.',
	'emailcapture-success' => 'از شما متشکرم!

رایانامهٔ شما با موفقیت تأیید شد.',
	'emailcapture-instructions' => 'برای تأیید نشانی رایانامهٔ خود، کدی را که برای شما ارسال شده بود را وارد کنید و بر روی «{{int:emailcapture-submit}}» کلیک کنید.',
	'emailcapture-verify' => 'کد تأیید:',
	'emailcapture-submit' => 'تأیید رایانامه',
);
...
$messages['ksh'] = array(
	...
	'emailcapture-already-confirmed' => 'Ding Addräß fö de <i lang="en">e-mail</i> es ald beschtäätesch jewääse.',
 ...
 */
$messages['ta'] = array(
	'emailcapture' => 'மின்னஞ்சல் உறுதிப்படுத்தல்',
	'emailcapture-failure' => "உங்கள் மின்னஞ்சல் உறுதிசெய்யப்பட'''வில்லை'''.",
	'emailcapture-invalid-code' => 'செல்லாத உறுதிபடுத்தல் குறியீடு.',
	'emailcapture-already-confirmed' => 'உங்கள் மின்னஞ்சல் முகவரி ஏற்கனவே உறுதி செய்யப்பட்டுள்ளது.',
	'emailcapture-response-subject' => '{{SITENAME}} மின்னஞ்சல் முகவரி உறுதிப்படுத்தல்',
	'emailcapture-response-body' => 'வணக்கம்!
...
{{SITENAME}}வை மேம்படுத்தலில் நீங்கள் எவ்வாறு உதவலாம் நாங்கள் விரைவில் உங்களுக்கு தெரிவிக்கிறோம்.
...
நீங்கள் இந்தக் கோரிக்கையை ஆரம்பிக்கவில்லையெனில், தயவுசெய்து இந்த மின்னஞ்சலை புறக்கணித்துவிடவும் மேலும் வேறு எதுவும் நாங்கள் அனுப்ப மாட்டோம்.',
	'emailcapture-success' => 'நன்றி!

உங்கள் மின்னஞ்சல் வெற்றிகரமாக உறுதிசெய்யப்பட்டது.',
	'emailcapture-instructions' => 'உங்கள் மின்னஞ்சல் முகவரியை உறுதிப்படுத்த, உங்களுக்கு மின்னஞ்சல் செய்யப்பட்ட குறியீட்டை உள்ளிட்டு சொடுக்கவும் "{{int:emailcapture-submit}}".',
	'emailcapture-verify' => 'உறுதிப்படுத்தல் குறியீடு:',
	'emailcapture-submit' => 'மின்னஞ்சல் முகவரியை உறுதிப்படுத்து',
);
...
$messages['te'] = array(
	...
	'emailcapture-invalid-code' => 'చెల్లని నిర్ధారణ సంకేతం.',
...
Дякуємо за виявлений інтерес щодо поліпшення {{grammar:genitive|{{SITENAME}}}}.
...
Ми повідомимо вам як ви можете допомогти поліпшити {{grammar:accusative|{{SITENAME}}}}.
